...
import {
  EnderecoTipoArgs,
  EnderecoTipoDto,
} from "./entities/endereco-tipo.entity";
import { EnderecoArgs, EnderecoDto } from "./entities/endereco.entity";
import {
  NaturezaJuridicaArgs,
  NaturezaJuridicaRespostaDto,
} from "./entities/natureza_juridica.entity";
...
export class PessoaResolver {
  ...
  CriarNovaPessoa(
    @Args("inserirPessoaInput") inserirPessoaInput: InserirPessoaInputDto,
  ) {
  ...
  AtualizeEstaPessoa(
    ...
    @Args("updatePessoaInput") updatePessoaInput: UpdatePessoaInputDto,
  ) {
